...
public class Food_Starter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productref_car = FirebaseDatabase.getInstance().getReference().child("Catering").child("Starter") ;
        recyclerView_car = findViewById(R.id.recycler_menu_starter) ;
        ...
        searchView = findViewById(R.id.search_starter);
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder_car, int position, @NonNull final Products model) {
                ...
                holder_car.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(Food_Starter.this, Product_Details_Out.class);
