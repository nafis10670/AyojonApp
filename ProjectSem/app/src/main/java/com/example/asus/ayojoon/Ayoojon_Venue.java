...
public class Ayoojon_Venue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productref_car = FirebaseDatabase.getInstance().getReference().child("Venue") ;
        recyclerView_car = findViewById(R.id.recycler_menu_venue) ;
        ...
        searchView = findViewById(R.id.search_venue);
