...
public class Food_Drink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productref_car = FirebaseDatabase.getInstance().getReference().child("Catering").child("Drinks") ;
        recyclerView_car = findViewById(R.id.recycler_menu_drink) ;
        ...
        searchView = findViewById(R.id.search_drink);
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder_car, int position, @NonNull final Products model) {
                ...
                holder_car.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(Food_Drink.this, Product_Details_Out.class);
