...
public class Food_Drink extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter_starter = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options_starter) {
            @Override
            protected void onBindViewHolder(@NonNull ProductViewHolder holder_drink, int position, @NonNull final Products model_starter) {

                holder_drink.txtname.setText(model_starter.getTitle());
                holder_drink.txtdesc.setText(model_starter.getDescription());
                Picasso.get().load(model_starter.getImage()).into(holder_drink.imageView) ;
                holder_drink.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(Food_Drink.this,Product_Details.class);
